...
__Luis:__
- Agregar ventana para el botón de "Opciones" donde esté lo siguiente: Quitar la música, Quitar los efectos de sonido.
...
- Codigo para llevar al jugador de un nivel a otro
